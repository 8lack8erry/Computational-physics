...
int main(int argc, char **argv) {
    ...
    vector<double> par = {0.3, 0.3, 0.3};
    vector<string> h ={"x1", "y1", "z1", "x2", "y2", "z2", "x3", "y3", "z3", "vx1", "vy1", "vz1", "vx2", "vy2", "vz2", "vx3", "vy3", "vz3"};

    ode_Solution(g, "E", 0., x_0, par, "3Corpi_E.dat", h, 0.01, 100., 10);
    ode_Solution(g, "RK2", 0., x_0, par, "3Corpi_RK2.dat", h, 0.01, 100., 10);
    ode_Solution(g, "RK4", 0., x_0, par, "3Corpi_RK4.dat", h, 0.01, 100., 10);
